...
if __name__ == '__main__':
    ...
    url_string = (r"" + os.path.dirname(__file__) + "/web_file5.html")
    ...
    # browser.page().runJavaScript("alert('abc')")
    # browser.page().runJavaScript("showAlert()")
    # browser.page().runJavaScript("document.getElementById('buttonClick').value='fffname'")
    browser.show()
